...
def test_dimension_score_creation():
    ...
    score = DimensionScore(
        dimension="项目经历", score=25.0, max_score=30.0, reasoning="候选人有丰富的量化项目经验"
    )
...
def test_base_score_total_calculation():
    ...
    base_score = BaseScore(
        ...
        tech_stack=DimensionScore(dimension="技术栈", score=22.0, max_score=25.0, reasoning="扎实"),
...
def test_evaluation_result_creation():
    ...
    evaluation = EvaluationResult(
        ...
        bonus_score=BonusScore(
            competitions=["数学建模"], bonus_points=8.0, reasoning="数学建模竞赛获奖"
        ),
        final_score=90.0,
...
def test_dimension_score_validation():
    ...
    with pytest.raises(ValueError, match="cannot exceed max_score"):
        DimensionScore(dimension="项目", score=35.0, max_score=30.0, reasoning="测试")

    # 测试reasoning不能为空
    with pytest.raises(ValueError):
        DimensionScore(dimension="项目", score=25.0, max_score=30.0, reasoning="")
